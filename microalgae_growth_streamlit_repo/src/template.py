...
TEMPLATE_COLUMNS: Dict[str, List[str]] = {
    "study": ["title", "authors", "year", "journal", "doi", "url", "cultivation_focus", "notes"],
    "organism": ["genus", "species", "strain", "taxonomy_id", "source_collection", "engineered", "engineering_notes"],
    "media": ["name", "mode", "carbon_source", "carbon_conc_gL", "nitrogen_source", "nitrogen_as_N_mM", "phosphorus_as_P_mM", "micronutrients", "salinity_gL", "c_to_n_molar", "notes"],
    "reactor": ["reactor_type", "working_volume_L", "light_path_cm", "mixing_rpm", "aeration_vvm", "gas_co2_percent", "gas_flow_Lmin", "notes"],
    "experiment": [
        "exp_code",
    ...
    "outcome": ["experiment_id", "exp_code", "mu_d1", "biomass_gL", "biomass_prod_gL_d", "protein_pct_dw", "protein_prod_gL_d", "lipid_pct_dw", "carb_pct_dw", "measurement_basis", "stats_type", "sd_or_se", "n_points", "notes"],
    "timeseries": ["experiment_id", "exp_code", "time_d", "biomass_gL", "nitrate_as_N_mM", "phosphate_as_P_mM", "protein_pct_dw", "notes"],

"signal_timeseries": [
    "experiment_id", "exp_code", "time_d",
    "absorbance_od", "cells_per_ml", "pressure_kPa", "pH",
    "notes"
],
}
